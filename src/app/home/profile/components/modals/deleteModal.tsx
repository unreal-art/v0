    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <p className="text-primary-7 text-sm">
                Deleting your account will permanently remove your profile, credits, and all associated data, including your generated images and history. 
                Any remaining credits will be lost, and this action is irreversible. To confirm, type <strong className="text-primary-5">DELETE</strong> in the field below.
            </p>

            <form>

                <label className="text-primary-4 mb-2 block">Confirm Account Deletion</label>
                ...
                <input 
                    ...
                    type="text" placeholder="Enter DELETE to proceed" />
