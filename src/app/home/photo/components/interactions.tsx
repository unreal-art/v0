    ...
    return (
        <div className="flex justify-between">
            <div className="flex py-2 gap-x-14">
                ...
                <button onClick={() => setOpenShare(true)} className="flex items-center gap-[2px] justify-center">
            ...
            <ShareModal open={openShare} setOpen={setOpenShare} link={"https://unreal.art/home/photo/" + postId} />
        </div>
    );
}
