  ...
  return (
    <>
      <div
        ...
        className="fixed  top-0 left-0 h-screen w-full bg-gray-950/50"></div>

      <div className="absolute flex justify-center items-center top-0 left-0 h-screen w-full">

        <div
          onClick={() => setImageIndex(-1)}
          className="absolute flex justify-center items-center top-0 left-0 h-screen w-full"></div>
          ...
          <div className="bg-primary-13 h-full w-full rounded-md">
            ...
            <div className="grid grid-cols-1 h-full md:grid-cols-2">
              ...
              <div className="h-fit">
                ...
                <CommentArea image={image} imageLoading={imageLoading} userName={userName} isLoading={isLoading} />
