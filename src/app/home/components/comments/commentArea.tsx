...
export default function CommentArea({ image, imageLoading, userName, isLoading, postId }: CommentAreaProps) { 
    ...
    return (
        <div className="flex flex-col">
            ...
            <div>
                {" "}
                <CommentTextbox postId={postId} reply={reply} closeReply={handleCloseReply}  />{" "}
            </div>
        </div>
    );
}
