...
export default function Search() {
    ...
    return (
        <>
            ...
            <button
                className={`flex gap-x-1 h-9 w-10 items-center justify-center rounded-full ${hover ? "bg-primary-10" : ""}`}
                ...
                <>
                    ...
                    <div className="absolute w-full max-w-[1034px] h-[90vh] z-50 top-2 md:top-[5vh] left-0 md:left-60 border-primary-8 border-[1px] bg-primary-12 rounded-xl p-4">
                        ...
                        <div className="flex justify-between text-primary-3">
                            <p className="nasalization text-2xl">Search for Anything Imaginable</p>
                            <div
                        ...
                        <div className="my-2"><Tabs currentIndex={currentIndex} setCurrentIndex={setCurrentIndex} /></div>

                        <div className="overflow-y-auto h-[70vh]">

                            { currentIndex === 0 && <UserSearch /> }

                            { currentIndex === 1 && <SearchPhotoGallary /> }
