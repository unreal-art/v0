...
export default function GenerateTextField({
  ...
  return (
    <>
      ...
      <div onClick={handleClose} className="fixed z-30 top-0 left-0 h-screen w-full"></div>
          ...
          <div className="flex flex-col bg-primary-13 h-full w-full rounded-md">
            ...
            <div className="flex-grow">
              ...
              <textarea
                ...
                className="bg-inherit w-full h-full resize-none outline-none p-4 text-primary-8 placeholder:text-primary-8"></textarea>
