...
/**
 * Component to display information about a single mint action
 */
export default function MintCard({ mint, isExpanded = false }: MintCardProps) {
  // Format the mint date nicely
  ...
  // Get a shortened version of the transaction hash if available
    ...
    <div className={`bg-gray-900 rounded-lg p-3 mb-2 ${isExpanded ? 'flex flex-col' : 'flex items-center justify-between'}`}>
      <div className="flex items-center">
        ...
        <div className="flex items-center text-yellow-400">
          <MintFillIcon className="w-4 h-4 mr-1" />
